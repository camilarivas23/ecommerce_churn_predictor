...
async def predict_form():
    ...
    <body>
        ...
        <script>
        const fields = ['total_orders','total_items_purchased','unique_products_bought','unique_categories_bought','total_spent','avg_product_rating','avg_discount_pct'];
        const calcFields = ['avg_cart_size','avg_order_value','avg_price_per_item'];
