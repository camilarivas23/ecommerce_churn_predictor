...
|--------|----------|-------|
| Full Features | 13 | ~1.00 |
| Filter | 12-13 | N/A |
| RFE | 5 | N/A |
| Random Forest | 13 | ~1.00 |
| Decision Tree | 13 | ~1.00 |

**Decision**: Use all 13 features (small set, no aggressive reduction needed)
...
```json
{
  ...
  "confidence": 0.89,
  "top_features": [
    {"name": "days_since_last_cart", "importance": 0.3534, "value": 45.0},
    {"name": "is_active_last_30d", "importance": 0.2862, "value": 0.0},
    {"name": "is_active_last_7d", "importance": 0.197, "value": 0.0}
  ],
...
1. **days_since_last_cart** (35%) — PRIMARY: Time since last activity
2. **is_active_last_30d** (29%) — 30-day activity flag
